...
const projects: Project[] = [
  {
    ...
    status: "Live",
    image: "/project-shots/project-205627.png",
    accent: "#ec4899",
    accentTwo: "#a855f7",
  ...
  },
  {
    ...
    status: "Live",
    image: "/project-shots/project-205753.png",
    accent: "#8b5cf6",
    accentTwo: "#2563eb",
  ...
  },
  {
    ...
    status: "Live",
    image: "/project-shots/project-210330.png",
    accent: "#22d3ee",
    accentTwo: "#8b5cf6",
  ...
  },
  {
    ...
    status: "Live",
    image: "/project-shots/project-210410.png",
    accent: "#3b82f6",
    accentTwo: "#10b981",
  ...
  },
  {
    ...
    status: "Live",
    image: "/project-shots/project-210436.png",
    accent: "#84cc16",
    accentTwo: "#06b6d4",
  ...
  },
  {
    ...
    image: "/project-shots/project-192632.png",
    accent: "#ef4444",
    accentTwo: "#22c55e",
  ...
  },
  {
    ...
    status: "Local / Case Study",
    image: "/project-shots/project-webguard.png",
    accent: "#10b981",
    accentTwo: "#14b8a6",
  ...
  return (
    <div className={`relative ${heightClass} min-w-0 overflow-hidden rounded-md bg-[#020617]`}>
      <Image
        ...
        className={`${isModal ? "object-contain" : "object-cover"} transition duration-700 group-hover:scale-105`}
      />
    </div>
  );
}
